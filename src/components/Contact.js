  ...
  return (
    <div name='contact' className='w-full h-screen bg-gradient-to-b from-black to-gray-800 text-white'>
      <div className='flex flex-col justify-center max-w-screen-lg mx-auto w-full h-full'>
        <div className='pb-8'>
          <p className='text-4xl p-2 font-bold inline border-b-4 border-gray-500'>Contact</p>
          <p className='py-6'>Submit the form below to get in touch with me</p>
        </div>
        <div className='flex justify-center items-center'>
          <form action="https://getform.io/f/2fe0e17c-62b2-4aa0-9815-1770d5c18aae" method="POST" className='flex flex-col w-full md:w-1/2'>
